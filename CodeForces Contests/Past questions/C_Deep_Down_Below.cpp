...
void solve(){
    ...
    for(int i = 0; i<n; i++){
        ...
        result[i].first = minm;
        result[i].second = minm + input[i].size();
    }
    if(n == 1){
    ...
    for(int i = 0; i<n; i++){
        if(i == 0){
            minindex = i;
            minm = result[i].second;
            continue;
        }
        if(minm < result[i].first){
            result[i].first -= result[minindex].second - result[minindex].first;
            minindex = i;
            minm = result[i].second;
        }
        else{
    ...
    cout<<result[minindex].first<<endl;
}
int main()
{
 fast_cin();
